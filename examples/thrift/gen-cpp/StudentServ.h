...
class StudentServIfSingletonFactory : virtual public StudentServIfFactory {
 public:
  StudentServIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<StudentServIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<StudentServIf> iface_;
};
...
class StudentServClient : virtual public StudentServIf {
 public:
  StudentServClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  StudentServClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class StudentServProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  StudentServProcessor(::apache::thrift::stdcxx::shared_ptr<StudentServIf> iface) :
    iface_(iface) {
...
class StudentServProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  StudentServProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< StudentServIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< StudentServIfFactory > handlerFactory_;
};

class StudentServMultiface : virtual public StudentServIf {
 public:
  StudentServMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<StudentServIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~StudentServMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<StudentServIf> > ifaces_;
  StudentServMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<StudentServIf> iface) {
...
class StudentServConcurrentClient : virtual public StudentServIf {
 public:
  StudentServConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  StudentServConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
